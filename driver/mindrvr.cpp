...

{
   ...
   if ( reg_config_info[1] == REG_CONFIG_TYPE_ATA || reg_config_info[1] == REG_CONFIG_TYPE_ATAPI )
   {
      pio_outbyte( CB_DH, CB_DH_DEV1 );
      DELAY400NS;
      numDev ++ ;
   }
   if ( reg_config_info[0] == REG_CONFIG_TYPE_ATA || reg_config_info[0] == REG_CONFIG_TYPE_ATAPI )
   {
      pio_outbyte( CB_DH, CB_DH_DEV0 );
      DELAY400NS;
      numDev ++ ;
...

{
   ...
   return io_in8(pio_reg_addrs[ addr ]);
}
...

{
   ...
   io_out8(pio_reg_addrs[ addr ], data);
}
...

{
   ...
   return io_in16(pio_reg_addrs[ addr ]);
}
...

{
   ...
   io_out16(pio_reg_addrs[ addr ], data);
}
...

{
   ...
   return io_in32(pio_reg_addrs[ addr ]);
}
...

{
   ...
   io_out32(pio_reg_addrs[ addr ], data);
}
