...
void RTC::init() {
    ...
    RTC::year    = bcd_to_num(t[6]) * 100 + bcd_to_num(t[5]);
    RTC::month   = bcd_to_num(t[4]);
    RTC::day     = bcd_to_num(t[3]);
    RTC::hour    = bcd_to_num(t[2]);
    RTC::minutes = bcd_to_num(t[1]);
    RTC::second  = bcd_to_num(t[0]);
}
